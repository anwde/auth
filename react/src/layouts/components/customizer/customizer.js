...
const Customizer = (props) => {
  ...
  const handle_customizer = () => {  
       props.dispatch(setCustomizer_show(!settings.customizer_show)); 
  };

  return (
    <aside   id="customizer" className={[
                    "customizer",
                    settings.customizer_show ? "show-service-panel" : "",
                ].join(" ")}>
      {/*--------------------------------------------------------------------------------*/}
      ...
      <span 
        className={[
                        "service-panel-toggle text-white",
                        settings.customizer_show ? "show" : "hide",
                    ].join(" ")}

        onClick={()=>{handle_customizer()}}
      >
        ...
        <div className="customizer-body">
          ...
          <div className="mt-3 border-bottom px-3">
            ...
            <ul className="theme-color mt-2 mb-3">
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeLogoBg==='skin1' ? "check" : "",].join(" ")}
                  data-logobg="skin1"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeLogoBg==='skin2' ? "check" : "",].join(" ")}
                  data-logobg="skin2"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeLogoBg==='skin3' ? "check" : "",].join(" ")}
                  data-logobg="skin3"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeLogoBg==='skin4' ? "check" : "",].join(" ")}
                  data-logobg="skin4"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeLogoBg==='skin5' ? "check" : "",].join(" ")}
                  data-logobg="skin5"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeLogoBg==='skin6' ? "check" : "",].join(" ")}
                  data-logobg="skin6"
          ...
          <div className="mt-3 border-bottom px-3">
            ...
            <ul className="theme-color mt-2 mb-3">
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeNavbarBg==='skin1' ? "check" : "",].join(" ")}
                  data-navbarbg="skin1"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeNavbarBg==='skin2' ? "check" : "",].join(" ")}
                  data-navbarbg="skin2"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeNavbarBg==='skin3' ? "check" : "",].join(" ")}
                  data-navbarbg="skin3"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeNavbarBg==='skin4' ? "check" : "",].join(" ")}
                  data-navbarbg="skin4"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeNavbarBg==='skin5' ? "check" : "",].join(" ")}
                  data-navbarbg="skin5"
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeNavbarBg==='skin6' ? "check" : "",].join(" ")}
                  data-navbarbg="skin6"
          ...
          <div className="mt-3 border-bottom px-3">
            ...
            <ul className="theme-color mt-2 mb-3">
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeSidebarBg==='skin1' ? "check" : "",].join(" ")}
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeSidebarBg==='skin2' ? "check" : "",].join(" ")}
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeSidebarBg==='skin3' ? "check" : "",].join(" ")}
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeSidebarBg==='skin4' ? "check" : "",].join(" ")}
              ...
              <li className="theme-item">
                <span
                  className={["theme-link",settings.activeSidebarBg==='skin5' ? "check" : "",].join(" ")}
              ...
              <li className="theme-item">
                <span
                  className= {["theme-link",settings.activeSidebarBg==='skin6' ? "check" : "",].join(" ")}
          ...
          <div className="mt-3 border-bottom px-3">
            <h5 className="font-medium m-0">Reset  Style</h5>
            <div
              className="btn-group btn-group-toggle mt-2 mb-3"
              data-toggle="buttons"
            >
...
export default connect((store) => ({ ...store }))(Customizer); 
